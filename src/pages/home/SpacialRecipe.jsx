...
const SpacialRecipe = () => {
    return (
        <div className='md:w-10/12 mx-auto mt-5 mb-10'>
            <h2 className='text-3xl text-center font-thin md:mt-16'>Japanese</h2>
            <h2 className='text-3xl text-center mb-10 font-serif'>SPECIALITIES</h2>
            <div className='md:flex md:justify-center'>
                <div className='md:w-1/2 m-5 md:relative'>
                    <img className='rounded md:absolute md:left-12' src="../../../public/Traditional-Japanese-Foods.jpg" alt="" />
                </div>
